...
-- Appearance
c.appearance.color                    = { white = 0.90, red = 1 }    -- Indicator background color, e.g., {red = 0.5, blue = 0 }
...
c.advanced.maxRefreshRate             = 1                 -- How aggressively to refresh Stackline. Higher = slower response time + less battery drain
